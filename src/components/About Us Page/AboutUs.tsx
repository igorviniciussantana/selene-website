      ...
      <div className={styles.about_wrapper}>
        <div className={styles.about_content}>
          ...
          >
            ...
            dos nossos clientes. <br/><br/>Combinamos expertise técnica, criatividade e
      ...
      <div className={`${styles.about_wrapper} ${styles.bg_purple}`}>
        ...
        <div className={styles.about_content}>
          ...
          >
            ...
            valor aos negócios. <br/><br/>Nosso compromisso é oferecer resultados
      ...
      <div className={styles.about_wrapper}>
        <div className={styles.about_content}>
          ...
          >
            ...
            serviços às necessidades específicas de cada cliente. <br/><br/>Nossa equipe é
      ...
      <div className={`${styles.about_wrapper} ${styles.bg_purple}`}>
        ...
        <div className={styles.about_content}>
          ...
          >
            ...
            tecnologias.<br/><br/> Nosso compromisso com a excelência reflete-se em cada
      ...
      <div className={styles.about_wrapper}>
        <div className={styles.about_content}>
          ...
          >
            ...
            negócio. <br/><br/>Trabalhamos em estreita colaboração com nossos clientes,
